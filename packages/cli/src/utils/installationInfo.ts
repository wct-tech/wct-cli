...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.pnpm/global')) {
      const updateCommand = 'pnpm add -g @wct-cli/wct-cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @wct-cli/wct-cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/bin')) {
      const updateCommand = 'bun add -g @wct-cli/wct-cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @wct-cli/wct-cli@latest';
    return {
