...
If you installed the CLI globally (e.g., `npm install -g @wct-cli/wct-cli`), use the `npm uninstall` command with the `-g` flag to remove it.

```bash
npm uninstall -g @wct-cli/wct-cli
```
